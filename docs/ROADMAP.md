...
| Main CI | **RECOVERY IN PROGRESS** | Local xdist instability root-caused and fixed 2026-09-20 (Q01); main-branch CI matrix needs re-observation after the fix lands (Q02 gate: three consecutive green runs); PR #323 now superseded locally | [Delivery evidence](research/2026-09-20-planning-evidence.md), [DISCOVERIES](../DISCOVERIES.md) |
