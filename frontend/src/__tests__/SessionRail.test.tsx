...
function buildState(overrides: Record<string, unknown> = {}): SessionStoreState {
  return {
    ...
    toggleUserBreakpoint: vi.fn(),
    clearUserBreakpoints: vi.fn(),
    loading: false,
    ...
    setAuditReport: vi.fn(),
    setAuditLoading: vi.fn(),
    setAuditError: vi.fn(),
    setDecisionJustification: vi.fn(),
    setDecisionJustificationLoading: vi.fn(),
    setDecisionJustificationError: vi.fn(),
    setEvidenceGraph: vi.fn(),
    setEvidenceGraphLoading: vi.fn(),
    setEvidenceGraphError: vi.fn(),
    setPortfolioReport: vi.fn(),
    setPortfolioLoading: vi.fn(),
    setPortfolioError: vi.fn(),
    inspectEvent: vi.fn(),
